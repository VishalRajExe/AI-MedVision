...
![Precision Recall Curves](results/recal.png)

**ROC Curves**
![ROC Curves](results/roc.png)

**Quality Metrics - Normal vs Abnormal**
![Quality Metrics](frontend/public/qm.png)

## 📸 Application Screenshots

### Main Interface - upload ecg signal via csv or mit-bh test record
![Main Interface](results/ecg_main.png)

### Classification Results

**Normal Heartbeat Detection**
![Normal Classification](results/ecg_normal.png)

**Ventricular Arrhythmia Detection**
![Ventricular Classification](results/ecg_ventricular.png)
